...
Vslope  <- rep(0.063, 6)
Vint    <- rep(5.47, 6)
aV      <- rep(0.000008, 6)  # v1 --> rep(0.000000075, 6)
Kslope  <- rep(c(0.025, 0.035, 0.025),2)
Kint    <- rep(3.19, 6)
aK      <- rep(10, 6)  # v1 --> rep(0.15625, 6)
...
tau_r   <- c(0.00052, 0.3)
tau_K   <- c(0.00024, 0.1)
Tau_MOD <- c(100, 0.8, 1.2, 2)  # v1 __. c(100, 0.6, 1.3, 3.5)
...
fW_p1 <- 0.58 #* 0.6867031  # MSBio new
fW_p2 <- 0.86 #* 0.6300376  # MSBio new
